...
void SystemInit (void) {
  ...
  /* WDOG->CS2: WIN=0,FLG=0,xx=0,PRES=0,xx=0,xx=0,CLK=1 */
  ...
  /* SIM->CLKDIV: xx=0,xx=0,OUTDIV1=0,xx=0,xx=0,xx=0,OUTDIV2=0,xx=0,xx=0,xx=0,OUTDIV3=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0 */
  ...
  /* OSC->CR: OSCEN=0,xx=0,OSCSTEN=0,OSCOS=0,xx=0,RANGE=0,HGO=0,OSCINIT=0 */
  OSC->CR = 0x00U;
...
#elif (CLOCK_SETUP == 1)
  /* SIM->CLKDIV: xx=0,xx=0,OUTDIV1=0,xx=0,xx=0,xx=0,OUTDIV2=1,xx=0,xx=0,xx=0,OUTDIV3=1,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0,xx=0 */
  SIM->CLKDIV = SIM_CLKDIV_OUTDIV1(0x00); /* Update system prescalers */
  /* Switch to FEE Mode */
  /* ICS->C2: BDIV=0,LP=0 */
  ICS->C2 &= (uint8_t)~(uint8_t)((ICS_C2_BDIV(0x07) | ICS_C2_LP_MASK));
  /* OSC->CR: OSCEN=1,xx=0,OSCSTEN=0,OSCOS=1,xx=0,RANGE=1,HGO=0,OSCINIT=0 */
